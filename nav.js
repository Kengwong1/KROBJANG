/**
 * nav.js — แก้เมนูที่นี่ที่เดียว อัปเดตทั้งเว็บทันที
 * ใช้งาน: <script src="nav.js"></script> ในทุกหน้า
 * ทำงานได้ทั้ง file:// และ https://
 */
(function () {

  // ============================================================
  // CSS ทั้งหมดของ Header + Nav
  // ============================================================
  var CSS = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  header.site-header {
    ...
    box-shadow: 0 2px 20px rgba(106,76,147,0.4);
    position: sticky;
    top: 0;
    z-index: 1000;
  }
  ...
  @media (max-width: 768px) {
    ...
    .nav-wrap a i { font-size: 1rem; width: 20px; text-align: center; }
  }
  `;

  // ============================================================
  // HTML ของ Header + Nav
  // ถ้าอยากเพิ่ม/ลบเมนู แก้ที่นี่ที่เดียว
  // ============================================================
  var HTML = `
  ...
  // ============================================================
  // inject HTML ก่อน <body> เนื้อหาแรก
  // ============================================================
  ...
  // รองรับทั้ง file:// (ได้ชื่อไฟล์) และ https:// (ได้ path)
  if (!page || page === '') page = 'index';

  document.querySelectorAll('.nav-wrap a[data-page]').forEach(function (a) {
    if (a.dataset.page === page) a.classList.add('active');
  });

  // fallback: ถ้าเป็นบทความ เช่น ai_1234.html → ไฮไลต์ ai
  if (!document.querySelector('.nav-wrap a.active')) {
    var cat = page.split('_')[0];
    var match = document.querySelector('.nav-wrap a[data-page="' + cat + '"]');
